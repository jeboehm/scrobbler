package de.ressourcenkonflikt.scrobbler.LastFm.Transformer;
...
public class TrackTransformer {
    public static Song transform(Track track) {
        return new Song(track.getArtist(), track.getName(), track.getPlayedWhen());
    }
}
